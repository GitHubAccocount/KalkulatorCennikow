...
@section('content')
      ...
      <form action="{{route('calculateg13')}}" method="POST">
        @csrf
        ...
        <x-label-number-input for="consumption3" title="Wpisz miesięczne zużycie prądu w strefie 3 (pozostałe godziny)"/>
        <x-number-input id="consumption3" name="consumption3" span="kWh" :is-required="true"/>
